...
# Configuration
schedule_file = "/var/local/Mercury2-HWM/schedules/offline_schedule.json"
satellite = "JSpOC-710"
ground_station = "MXL"
...
passes_api = "http://exploration.engin.umich.edu/satops/fetchtle/api/passes/"+satellite+".json?pass_count="+str(pass_count)+"&ground_stations=MXL&min_elevations="+str(min_elevation)+"&show_all_passes=false"
try:
